...
import { updateBreweryStatus } from "@/actions/breweries";

const BreweryAdminMenu = ({
    id,
    status,
    slug
}: {
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent side="bottom" align="start">
                ...
                <DropdownMenuItem>
                    <Link href={`/breweries/edit/${slug}`}>Edit</Link>
                </DropdownMenuItem>
            </DropdownMenuContent>
        </DropdownMenu>
    );
};
export default BreweryAdminMenu;

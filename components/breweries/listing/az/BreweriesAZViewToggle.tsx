...
import { useBreweriesAZParams } from "@/hooks/useBreweriesAZParams";
import { BreweriesViewToggleProps } from "@/types/breweries";
import { useEffect } from "react";

const BreweriesAZViewToggle = ({ paramsView }: BreweriesViewToggleProps) => {
    const { view, setView } = useBreweriesAZParams();
...
export default BreweriesAZViewToggle;

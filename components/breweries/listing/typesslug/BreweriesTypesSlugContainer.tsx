...
import { BreweriesTypesSlugContainerProps } from "@/types/breweries";
...
import BreweriesTypesSlugFilter from "./BreweriesTypesSlugFilter";
import BreweriesTypesViewToggle from "../types/BreweriesTypesViewToggle";

const BreweriesTypesSlugContainer = ({
    breweryTypes,
    initialTotal,
    slug
}: BreweriesTypesSlugContainerProps) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center">
            <BreweriesTypesSlugFilter breweryTypes={breweryTypes} slug={slug} />
            {isLoading ? (
                <>
...
export default BreweriesTypesSlugContainer;

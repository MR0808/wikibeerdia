...
import { BeersStylesSlugContainerProps } from "@/types/beers";
...
import BeersStylesSlugFilter from "./BeersStylesSlugFilter";
import BeerStylesViewToggle from "../styles/BeerStylesViewToggle";

const BeersStylesSlugContainer = ({
    parentStyles,
    initialTotal,
    parentSlug,
    styleSlug
}: BeersStylesSlugContainerProps) => {
...
export default BeersStylesSlugContainer;

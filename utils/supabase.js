...
var uploadImage = function (image, bucket) { return __awaiter(void 0, void 0, void 0, function () {
    var timestamp, newName, _a, data, error;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                timestamp = Date.now();
                newName = "".concat(timestamp, "-").concat(image.name);
            ...
            case 1:
                ...
                return [2 /*return*/, exports.supabase.storage.from(bucket).getPublicUrl(newName).data.publicUrl];
        }
    });
}); };
exports.uploadImage = uploadImage;
var deleteImage = function (url, bucket) {

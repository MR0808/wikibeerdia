...
export const styles: StyleType[] = [
    {
        ...
        style: [
            ...
            {
                name: "Belgian and French Origin",
                subStyle: [
    ...
    {
        name: "Hybrid/Mixed Lagers or Ale",
        style: [
            {
                name: "All Origin",
                subStyle: [
                    ...
                    { name: "Fresh Hop Beer" },
                    { name: "Wood-Aged Sour Beer" },
                    { name: "Barrel-Aged Sour Beer" },
                    { name: "Aged Beer" },

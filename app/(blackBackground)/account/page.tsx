...
export async function generateMetadata() {
    return {
        ...
        description: "Wikibeerdia Account Management"
    };
}
        ...
        <div className="container mt-36 flex h-16 flex-col justify-between sm:justify-between sm:space-x-0 md:space-x-4">
            <div className="flex w-full flex-col justify-between">
                <div className="flex flex-col gap-y-5">
                    ...
                    <Link
                        href="/profile"
                        className="hover:text-primary text-lg font-semibold text-blue-600"
                    >
                        View Profile
                    </Link>
                </div>
                    ...
                    {!user?.isOAuth && (
                        <Link href="/account/security">
                            <Card className="w-[350px] shadow-md hover:shadow-lg">
                                ...
                                <CardContent className="text-sm">
                                    Manage your passwords, 2FA and other
                                    important settings to keep you secure
                                </CardContent>
                            </Card>
                        </Link>
                    )}

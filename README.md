...
npx shadcn-ui@latest add breadcrumb card checkbox dropdown-menu input label popover select separator table textarea skeleton carousel
    ...
    return (
        <section>
            ...
            <p className="mt-6 text-lg tracking-wide leading-8 max-w-2xl mx-auto text-muted-foreground">
                ...
                hic distinctio ducimus temporibus nobis autem laboriosam
    ...
    return (
        <div className="mt-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 my-8">
                {reviews.map((review) => {
                    const { comment, rating, authorImageUrl, authorName } =
                        review;
                    const reviewInfo = {
                        comment,
                        rating,
